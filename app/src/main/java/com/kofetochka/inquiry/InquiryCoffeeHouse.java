...
public class InquiryCoffeeHouse extends Thread{
    ...
    private String[] arrayName_CH;
    private int l;

    JSONArray coffehouses = null;
    ...
    public void run(){
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://146143.simplecloud.club/kofetochkablg/get_coffeehouse.php");
        ...
        try {
            ...
            coffehouses = json_data.getJSONArray("coffeehouses");
            l = coffehouses.length();
            arrayName_CH = new String[l];
            for (int i = 0; i < l; i++) {
                JSONObject c = coffehouses.getJSONObject(i);
                arrayName_CH[i]= c.getString("Name_CH");
            }
