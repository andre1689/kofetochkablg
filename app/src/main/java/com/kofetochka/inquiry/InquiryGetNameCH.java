...
public class InquiryGetNameCH extends Thread{
    ...
    public void run(){
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://146143.simplecloud.club/kofetochkablg/get_name_ch.php");
        ...
        try {
            ...
            Name_CH = (json_data.getString("Name_CH"));
    ...
    public void start (String id_CH){
        this.ID_CH = id_CH;
        this.start();
    }
